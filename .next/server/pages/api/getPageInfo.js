...
/* harmony export */   "pageInfoQuery": () => (/* binding */ pageInfoQuery)
/* harmony export */ });
/* harmony import */ var next_sanity__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5091);
...
async function handler(req, res) {
    const pageinformation = await _sanity__WEBPACK_IMPORTED_MODULE_1__/* .sanityClient.fetch */ .i3.fetch(pageInfoQuery);
    res.status(200).json({
        pageinformation
    });
}
...
var __webpack_exports__ = (__webpack_exec__(6843));
