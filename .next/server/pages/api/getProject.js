...
/* harmony export */   "projectQuery": () => (/* binding */ projectQuery)
/* harmony export */ });
/* harmony import */ var next_sanity__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5091);
...
async function handler(req, res) {
    const project = await _sanity__WEBPACK_IMPORTED_MODULE_1__/* .sanityClient.fetch */ .i3.fetch(projectQuery);
    res.status(200).json({
        project
    });
}
...
var __webpack_exports__ = (__webpack_exec__(2897));
